<template>
  ...
  <el-form :model="form" ref="ruleFormRef" :rules="rules" label-width="auto" style="max-width: 600px">
    ...
    <el-form-item label="密码" prop="password1" class="reg-form">
      <el-input v-model="form.password1" placeholder="请输入您的密码" show-password style="width: 240px" :prefix-icon="Lock"
        size="large"></el-input>
    </el-form-item>
    <el-form-item label="确认密码" prop="password2" class="reg-form">
      <el-input v-model="form.password2" placeholder="请再次输入您的密码" show-password style="width: 240px" :prefix-icon="Lock"
        size="large"></el-input>
    </el-form-item>
