<template>
  <div class="login-title" :style="{ color: loginColor }">账号登录</div>
  <div>
    <el-form
      ref="ruleFormRef"
      :model="form"
    ...
    >
      ...
      <div class="bottom">
        <RouterLink :to="{ path: '/login/register' }">
          点击注册新账号
        </RouterLink>
      </div>
    </el-form>
...
backgroundImg.value =
  localStorage.getItem('backgroundImg') || '/public/images/back-image1.jpg' // 从本地存储中获取背景图片
...
function toggleTheme() {
  backgroundImg.value =
    backgroundImg.value === '/public/images/back-image1.jpg'
...
function applyTextColor() {
  textColor.value =
    backgroundImg.value === '/public/images/back-image1.jpg' ? 'black' : 'white'
}
...
const submitForm = function (this: any, formEl: FormInstance | undefined) {
  //formEl 形参
  if (!formEl) return
